...
import NaveenLogo from "@/assets/icon/navin-logo.png";
import PhoneLogo from "@/assets/icon/google-phone.png";
...
const Circle = forwardRef(({ className, children, onClick }, ref) => {
    return (
        <div
            ...
            ref={ref}
            className={cn(
                "hover:rotate-y-360 transition-all duration-1000 ease-in-out z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
                className,
            )}
        >
            {children}
...
const ContactAnimatedBeam = ({ className }) => {
        ...
        >
            <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-10">
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div1Ref} onClick={() => window.open("https://www.linkedin.com/in/naveenn82005/", "_blank")}>
                        <Icons.linkedIn />
                    </Circle>
                    <Circle ref={div5Ref} onClick={() => window.open("https://leetcode.com/u/navin82005/", "_blank")}>
                        <Icons.leetCode />
                    </Circle>
                </div>
                <div className="flex flex-row items-center justify-between">
                    <Circle ref={div2Ref} onClick={() => window.open("", "_blank")}>
                        <Icons.phone />
                    </Circle>
                    <Circle ref={div4Ref} className="size-16" onClick={() => navigator("/")}>
                        <Icons.navinLogo />
                    </Circle>
                    <Circle ref={div6Ref}>
                        <Icons.gmail />
...
export const Icons = {
    ...
    gmail: () => (
        <svg xmlns="http://www.w3.org/2000/svg" id="gmail" enableBackground="new 0 0 141.7 141.7" viewBox="0 0 141.7 141.7">
...
export default ContactAnimatedBeam;